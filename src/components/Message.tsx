  ...
  return (
    <div
      className={clsx(
        ...
        !isVisible && (message.role === 'user' ? 'opacity-0 translate-x-8' : 'opacity-0 -translate-x-8')
      )}
    >
      <div
        className={clsx(
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          {message.role === 'assistant' && (
            <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <button
                onClick={handleCopy}
